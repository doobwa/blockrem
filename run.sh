...
./parallel --sshlogin 8/d10 'cd /extra/duboisc0/blockrem;./predict.r -d "eckmann-small" -m {}' ::: "full.1"
./parallel --sshlogin 8/d10 'cd /extra/duboisc0/blockrem;./predict.r -d "eckmann-small" -b {}' ::: "uniform" "online" "marg"

./parallel --sshlogin 8/d8 'cd /extra/duboisc0/blockrem;./predict.r -d "twitter-small" -m {}' ::: "full.1"
./parallel --sshlogin 8/d7 'cd /extra/duboisc0/blockrem;./predict.r -d "twitter-small" -b {}' ::: "uniform" 

cd /extra/duboisc0/blockrem;./predict.r -d "twitter-small" -b "uniform"
cd /extra/duboisc0/blockrem;./predict.r -d "twitter-small" -b "online"
cd /extra/duboisc0/blockrem;./predict.r -d "twitter-small" -b "marg"
