...
\date[Department Update 2012] % (optional)
...
\end{align*}
\uncover<8->{
\footnotesize{See \cite{Nowicki2001, Kemp}.}
}
\end{frame}
...
\begin{frame}{Posterior predictive checks}
\includegraphics[scale=.4]{../../figs/synthetic/postpred-time}
\includegraphics[scale=.4]{../../figs/synthetic/postpred-pshift}
\end{frame}

\begin{frame}{Prediction experiment: Synthetic data}
Mean log likelihood for observed events and held out events.
\input{../../figs/synthetic/results.tex}
\end{frame}
...
\begin{picture}(0.0,0.0)
 ...
 \uncover<2->{  \put(.5,-0.25){\includegraphics[scale=.5]{../../figs/eckmann-small/params-estimates}}}
\end{picture}
\end{frame}

\begin{frame}{Prediction experiment: Eckmann subset}
Mean log likelihood for observed events and held out events.
\input{../../figs/eckmann-small/results.tex}
\end{frame}

\begin{frame}{Posterior predictive checks for $K=2$ model}
\includegraphics[scale=.4]{../../figs/eckmann-small/postpred-time}
\includegraphics[scale=.4]{../../figs/eckmann-small/postpred-pshift}
\end{frame}
...
Future directions
  \begin{itemize}
  \item Consider a mixed-membership approach
  \item Intelligent way to share parameters as $K$ grows
  \end{itemize}
}
\end{frame}
