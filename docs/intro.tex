...
- observe network data over time
- interested how nodes differ in the rate of activity with other parts of the network
  - why?
  - based on some other covariate
- methods for static networks can be applied to the marginal rate
  - model this heterogeneity by assuming subgroups of nodes have similar tendencies in their group-wise interactions.
