...
Here, we combine these two approaches by positing a latent partition on the vertex set, such that event dynamics within and between node sets evolve in potentially distinct ways.
