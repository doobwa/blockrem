...
\end{align}
The posterior distribution of $\mu$ given $\sigma$ and the lower level parameters can in turn be written as
\begin{align}
\label{eqn:gibbs.mu}
\mu_p | \boldsymbol{\beta},\sigma_p^2 &\sim \mbox{Normal}\left(\frac{1}{K}\sum_{k=1}^K \beta_{k,p},\frac{ \sigma_p^2}{\sqrt{K}}\right),
\end{align}
