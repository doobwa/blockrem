...
- [ ] fix  description in paper for pshift ('ego' issue)
- [ ] cite reality mining paper
...
- [ ] remove old effects from table
- [ ] mention CRP at the end of Section 2
- [ ] Describe sampling of mu and sigma 
- [ ] Fix description of intensities to have new ego setup
- [ ] Mention what happens with cluster pairs that have no
  events... shrinkage towards upper level mu
- [ ] Move split merge entirely to appendix
* Bugs
...
- [ ] add statistic transformation as an option in brem()
