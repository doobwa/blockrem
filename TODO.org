...
* Final week
- [ ] get synthetic example working again with new sampler
...
- [ ] Double check pshift implementation; is it global?
- [ ] Set up reality mining, classroom, and radio?
- [ ] implement recency stats
- [ ] Fit Eckmann and Twitter (w/o pshifts)
- [ ] Compare llk timing to Carter's code
** Paper
- [ ] Fix up notation borrowing notation from HierRelEvent paper.
