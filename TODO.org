...
- Why is synthetic fit making the dyad count effect so large? [wrong
  synthetic dataset?]
- Rerun synthetic data without degree effects?  
  - fix bug in synthetic fitting?
  - slice sampling seems to work better when K=1, but worse when K>1
